...
public class To5GBean {
    ...
    public To5GBean(String tac,String BAND, String NR_ARFCN, String PCI, String RSRP, String RSRQ, String SINR, String CID, int lac, int psc, String nr, String nrType, String mnc,String mcc) {
        this.tac=tac;
        this.BAND = BAND;
        this.NR_ARFCN = NR_ARFCN;
        this.PCI = PCI;
