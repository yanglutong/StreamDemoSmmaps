...
public class ViewLoading extends Dialog {
    ...
    private ViewLoading(Context context , String content , boolean canNotCancel) {
        ...
        if(content!=null && content.length()>0){
            ...
            TextView message = findViewById(com.pedaily.yc.ycdialoglib.R.id.message);
            message.setText(content);
        }else {
            setContentView(com.pedaily.yc.ycdialoglib.R.layout.layout_dialog_loaded);
        }
        ImageView progressImageView = findViewById(com.pedaily.yc.ycdialoglib.R.id.iv_image);
        //创建旋转动画
        ...
        //动画的重复次数
        animation.setRepeatCount(1000000000);
        //设置为true，动画转化结束后被应用
