...
public class JzListAdapter extends RecyclerView.Adapter<JzListAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.activity_map_info_list, viewGroup, false);
...
//        myViewHolder.title.setText(list.get(i).getAddress() + "");
        ...
        String str = "";
        if (list.get(i).getMnc().equals("00")||list.get(i).getMnc().equals("02")) {
            str = "移动";
        } else if (list.get(i).getMnc().equals("01")) {
            str = "联通";
        } else if (list.get(i).getMnc().equals("11")) {
            str = "电信";
        ...
        myViewHolder.tv_lat_lon.setText("纬度:" + lat + "" +"\n"+ "经度:" + lon);
...
//                        Toast.makeText(mcontext, "设置默认成功", Toast.LENGTH_LONG).show();
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        TextView title_num, tv_title, tv_fugai, tv_mnc, tv_lac, tv_cid, tv_address, tv_lat_lon, tv_resources,
