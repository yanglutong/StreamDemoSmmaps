package com.example.location.OrmSqlLite;

import android.content.Context;
import android.database.SQLException;
import android.database.sqlite.SQLiteDatabase;

import com.example.location.OrmSqlLite.Bean.Conmmunit01Bean;
import com.example.location.OrmSqlLite.Bean.GuijiViewBean;
import com.example.location.OrmSqlLite.Bean.GuijiViewBeanjizhan;
import com.example.location.OrmSqlLite.Bean.PinConfigBean;
