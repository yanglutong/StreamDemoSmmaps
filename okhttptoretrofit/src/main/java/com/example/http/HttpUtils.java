...
//     * @param callBack    结果返回接口
//     */
//    public void executePostRequestBody(Context context, String api,  TreeMap map, int type, HttpRequestCallback callBack){
//        mHttpRequest.mHttpPostRequestBody(context, api, map, type, callBack);
//    }
}